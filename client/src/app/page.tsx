...
export default function Home() {
  ...
  return (
    <div className="home-wrapper">
      ...
      <section className="section-padding" style={{ position: 'relative', overflow: 'hidden', paddingTop: '160px' }}>
        ...
        <div className="container" style={{ textAlign: 'center' }}>
          <div className="flex-center" style={{ marginBottom: '24px' }}>
            <div style={{ display: 'inline-flex', alignItems: 'center', gap: '8px', padding: '6px 16px', background: 'rgba(0, 229, 168, 0.1)', borderRadius: '99px', border: '1px solid rgba(0, 229, 168, 0.2)', color: 'var(--accent-green)', fontSize: '0.8rem', fontWeight: 800, letterSpacing: '1.5px' }}>
      ...
      <section className="section-padding" style={{ borderTop: '1px solid var(--card-border)', background: 'rgba(255,255,255,0.01)' }}>
        <div className="container">
          <div style={{ display: 'grid', gridTemplateColumns: 'repeat(auto-fit, minmax(280px, 1fr))', gap: '40px' }}>
            ...
            </div>            <div className="glass-panel" style={{ padding: '40px', borderLeft: '4px solid var(--accent-blue)' }}>
      ...
      </section>      {/* How it Works Deep Section */}
      ...
      </section>      {/* The Science of Detection: Deep Dive */}
      ...
      <section className="section-padding">
        <div className="container">
          <div className="glass-panel" style={{ padding: '80px', textAlign: 'center', background: 'linear-gradient(135deg, rgba(59, 130, 246, 0.1), rgba(168, 85, 247, 0.1))', position: 'relative', overflow: 'hidden' }}>
